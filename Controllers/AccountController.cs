...
namespace ASP_IDENTITY.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                ViewBag.Roles = new SelectList(db.Roles.Where(a => !a.Name.Contains("Admins")).ToList(), "Name", "Name");
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email , UserType = model.Roles};
        ...
        public ActionResult EditProfile(EditProfileViewModel profile)
        {
            ...
            {
                ViewBag.Message = "Current password enter  is incorrect";
            }
            else
            {
                ...
                db.SaveChanges();
                ViewBag.Message = "Prfoile data have been updated";
            }
